...
public class Optim_GenMcode {
    ...
    public Optim_GenMcode(N_MidItem compunit){
    ...
    private String gen_jlable() {
        String lablename = "$__jlable" + jlableindex;
        jlableindex++;
        return lablename;
    }
    ...
    public void MidLVal(N_MidItem LVal) {
        ...
        if ((inconstinit || inglobalinit)) {
            ...
            if (dim == 0 && vardim == 1) {
                ...
                if (var.getType()==1) {
                    this.tmpmulexp = var.getConstvalue()+"";
                }
    ...
    private void MidStmt(N_MidItem Stmt) {
        ...
        if (symbol instanceof N_SymItem) {
            ...
            if (sym.getType().equals(T_Typename.RETURNTK)) {
                ...
                midcodes.AddMark("BWHILE");
                MidWhile(nodes);
                midcodes.AddMark("EWHILE");
